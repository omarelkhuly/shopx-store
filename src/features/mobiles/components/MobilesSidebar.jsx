// src/features/mobiles/components/MobilesSidebar.jsx
...
import "@/styles/MobilesSidebar.css";

const MobilesSidebar = ({
    product,
    isOpen,
    onClose
}) => {
